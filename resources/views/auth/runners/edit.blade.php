                ...
                <div class="text-center"><img src="img/badakman.png"></div>
                    <form class="form-horizontal" method="POST" action="/runners/{{ $runner->id }}">
                        ...
                        <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select name="distance" class="form-control" >
                                    ...
                                    <option value="21 K">21 K (1250php)</option>
                        ...
                        <div class="form-group{{ $errors->has('contactperson') ? ' has-error' : '' }}">
                            <label for="tcontactpersoneam" class="col-md-4 control-label">Contact Person</label>

                            <div class="col-md-6">
                                <input id="contactperson" type="text" class="form-control" name="team" value="{{ $runner->contactperson }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('contactnumberperson') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="contactnumberperson" type="text" class="form-control" name="contactnumberperson" value="{{ $runner->contactnumberperson }}" required autofocus>
